        ...
        return <SDKBox title="确认支付" style={{width:device.pxTodp(730),height:device.pxTodp(670)}} back={this.back.bind(this)}>
            <View style={{ height: device.pxTodp(550), flexDirection: 'column', marginLeft: device.pxTodp(120), marginRight: device.pxTodp(120), marginTop: device.pxTodp(30), marginBottom: device.pxTodp(30) }}>
                ...
                <View style={{ flexDirection: 'row'}}>
                    <Image style={{ width: device.pxTodp(130), height: device.pxTodp(130) }} source={device.getAssert('facebook.png')} />
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                            ...
                            <View style={{  justifyContent: 'center', alignItems: 'center' }}>
                                <TouchableWithoutFeedback>
                                    <Image style={{ width: device.pxTodp(50), height: device.pxTodp(50) }} source={device.getAssert('payment/info.png')} />
                                </TouchableWithoutFeedback>
                            </View>
                        </View>
                ...
                <View style={{marginTop:device.pxTodp(40)}}>
                    <IBoxButton onPress={this.back.bind(this)} text="确认支付" style={{borderWidth:1,borderColor:'#C09C6A',borderRadius:5,backgroundColor:'#FFBE2A',borderRadius:5,height:device.pxTodp(70),justifyContent: 'center', alignItems: 'center'}} textStyle={{color:'#303038',textAlign:'center'}}/>
                </View>
                <View style={{marginTop:device.pxTodp(20)}}>
                    <IBoxButton onPress={this.back.bind(this)} text="更多支付方式" style={{borderWidth:1,borderColor:'#C09C6A',borderRadius:5,backgroundColor:'#1192D3',borderRadius:5,height:device.pxTodp(70),justifyContent: 'center', alignItems: 'center'}} textStyle={{color:'#DCF3FF',textAlign:'center'}}/>
                </View>
            </View>
        </SDKBox>
    }
