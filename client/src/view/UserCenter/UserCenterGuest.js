            ...
            <View style={{ flexDirection: 'column', flex: 1 }}>
                <View style={{backgroundColor:'red'}}>
                    <View style={Styles.warning}>
                        <Image style={Styles.warningIcon} source={device.getAssertV2('warnning.png')} />
                        <Text style={Styles.warningText}>建议尽快升级帐号，以防数据丢失</Text>
                    </View>
                </View>
                ...
                <View style={extendStyle(Common.margin_top_20, { flex: 1 })}>
                    <View style={{ marginLeft: device.pxTodp(100), marginRight: device.pxTodp(100), flexWrap: 'wrap', flexDirection: 'row' }}>
                        <TouchableWithoutFeedback onPress={this.changeView.bind(this, 'guestUpdate')}>
                            <View style={Styles.actionItem}>
                                <Image style={Styles.actionIcon} source={device.getAssertV2('levelup.png')} />
                                <Text style={Styles.actionText}>升级账号</Text>
                            </View>
