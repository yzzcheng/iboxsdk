...
export default class InputField extends Component {
    ...
    render() {
        ...
        return <View style={extendStyle({ flexDirection: 'row', alignItems: 'center'},Common.margin_left_20,Common.margin_right_20,style)}>
            <Image style={extendStyle({ width: device.pxTodp(24), height: device.pxTodp(24) },Common.margin_right_min)} source={leftIcon} />
            <View style={{flex:1,flexDirection: 'row', alignItems: 'center',borderColor:'#cdcdcd',borderWidth:1,borderStyle:'solid', height: device.pxTodp(30)}}>
