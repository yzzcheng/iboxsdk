...
-keep class com.qianqi.pay.beans.** {
    <fields>;
    <methods>;
}
...
-keep class com.iboxsdk2.singlton.IBoxSDKAPI { *;}

-keep interface com.iboxsdk2.abstracts.SDKCallback { *;}
-keep interface com.iboxsdk2.abstracts.InitCallback { *;}
-keep interface com.iboxsdk2.abstracts.LoginCallback { *;}
-keep interface com.iboxsdk2.abstracts.PaymentCallback { *;}



-keep class com.iboxsdk2.bean.SDKPayment { *;}
-keep class com.iboxsdk2.abstracts.SDKRoleInfo { *;}
-keep class com.iboxsdk2.abstracts.SDKUser { *;}
